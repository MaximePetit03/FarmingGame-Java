...
public class MainController {
    ...
    @FXML public AnimalController animalAreaController;
    ...
    public void placeAnimal(int index) {
        if (animals[index] == null) {
            if (inventory.goldenChickenInventory > 0) {
                animals[index] = new GoldenChicken();
                inventory.goldenChickenInventory -= 1;
            } else if (inventory.chickenInventory > 0) {
                animals[index] = new Chicken();
                inventory.chickenInventory -= 1;
            } else if (inventory.cowInventory > 0) {
                animals[index] = new Cow();
                inventory.cowInventory -= 1;
            }
    ...
    public void update() {
        if (moneyLabel != null) moneyLabel.setText("Richesse: " + inventory.money + " émeraudes");
        if (wheatSeedsBtn != null) wheatSeedsBtn.setText("Graines Blé: " + inventory.wheatSeeds);
        if (selectWheatBtn != null) selectWheatBtn.setText("Blé: " + inventory.wheatStock);
        if (waterMelonSeedsBtn != null) waterMelonSeedsBtn.setText("Graines Pastèque: " + inventory.waterMelonSeeds);
        if (selectWaterMelonBtn != null && waterMelonUnlocked) selectWaterMelonBtn.setText("Pastèque: " + inventory.waterMelonStock);
        if (milkStockBtn != null) milkStockBtn.setText("Lait: " + inventory.milkStock);
        if (eggStockBtn != null) eggStockBtn.setText("Oeufs: " + inventory.eggStock);
        if (selectEggBtn != null) selectEggBtn.setText("Oeuf: " + inventory.eggStock);
        if (goldenEggBtn != null) goldenEggBtn.setText("Oeufs Dorés: " + inventory.goldenEggStock);
        if (selectGoldenEggBtn != null) selectGoldenEggBtn.setText("Oeuf Doré: " + inventory.goldenEggStock);
